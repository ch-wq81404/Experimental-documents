...
TIM.xml: the high-level ontology for SysML.

autocar.owl: transformed from autocar.xml using Ont4SysML.jar.
PCS.owl: transformed from PCS model file using Ont4SysML.jar.